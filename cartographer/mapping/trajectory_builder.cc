...
proto::TrajectoryBuilderOptions CreateTrajectoryBuilderOptions(
  ...
  *options.mutable_trajectory_builder_3d_eskf_options() =
      mapping_3d::CreateESKFLocalTrajectoryBuilderOptions(
          parameter_dictionary->GetDictionary("trajectory_builder_3d_eskf").get());
